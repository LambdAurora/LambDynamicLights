...
public abstract class ItemLightSourceDataProvider
	...
	protected class Context extends LightSourceDataProvider<ItemLightSource, Context>.Context {
		...
		public void add(
			...
			this.add(key, ItemPredicate.Builder.item().of(items).build(), luminance, waterSensitive);
		}
		...
		public void add(
			...
			this.add(key, ItemPredicate.Builder.item().of(tag).build(), luminance, waterSensitive);
		}
